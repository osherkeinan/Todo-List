...
<%@page import="com.lifemichael.controller.*"%>
...
<form method="post" action="/Todo_List/controller/checkLogin" class="form-horizontal">
...
<input type="password" name="password" id="password" class="form-control"  placeholder="Enter password"/>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <div class="checkbox">
          <label><input type="checkbox" name="remember" value="true" data-toggle="popover" data-trigger="hover" data-content="Next time proceed straight to MyList"> Remember me</label>
        </div>
      </div>
    </div>
    <div class="form-group">        
