...
<form method="post" action="/Todo_List/controller/updatePassword" class="form-horizontal">
...
<input type="submit" value="Update" class="btn btn-primary"/> <input type="reset" value="reset" class="btn btn-default"/>
   </div>
  </div>
</form>
<script type="text/javascript">
	var password = document.getElementById("newPassword")
	, confirm_password = document.getElementById("password");
